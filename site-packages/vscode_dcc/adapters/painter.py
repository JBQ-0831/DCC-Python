...
class SubstancePainterAdapter(DCCAdapter):
    ...
    def get_python_path(self) -> str:
        ...
        """
        exe_dir = os.path.dirname(super().get_python_path())       # painter 中，这里返回的是根目录:C:/Program Files/Adobe/Adobe Substance 3D Painter
        print(f"SubstancePainterAdapter.get_python_path: exe_dir={exe_dir}")
