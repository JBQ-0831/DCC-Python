...
用法示例：
    python dcc_run.py file e:/vscode-maya-python/test/test_max.py
    python dcc_run.py code "print('hello')"
    python dcc_run.py ping
    echo "print(1+1)" | python dcc_run.py stdin

Windows 安装到 PATH（安装后可直接运行 dcc-run）：
