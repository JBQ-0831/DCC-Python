...
def install_debugpy(python_path: str):
    ...
    print(f"[DEBUG] install_debugpy: running: {python_path} -m pip install debugpy")

    try:
        result = subprocess.run(
            [python_path, "-m", "pip", "install", "debugpy","-i","https://pypi.tuna.tsinghua.edu.cn/simple"],
...
def start_debugpy_server(port: int, python_path: str) -> bool:
    if python_path is None:
